...
class kottler : public metric<coordinate_system::spherical, scalar_type, vector_type, christoffel_symbols_type>
{
public:
  ...
  __device__ termination_reason       check_termination  (const vector_type& position, const vector_type& direction) const override
  {
    ...
    if (position[1] < static_cast<scalar_type>(0) || std::abs(static_cast<scalar_type>(1) - rs / position[1] 
      - constants::cosmological_constant / static_cast<scalar_type>(3) * std::pow(position[1], 2)) <= constants::epsilon)
  ...
  __device__ christoffel_symbols_type christoffel_symbols(const vector_type& position) const override
  {
    ...
    const auto t5  = constants::cosmological_constant * t4;
    ...
    symbols.setZero();
    symbols(0, 0, 1) =  t6 / t4 * constants::speed_of_light_squared * t11 / static_cast<scalar_type>(18);
    symbols(0, 1, 0) =  t19;
    symbols(1, 0, 0) =  t19;
    symbols(1, 1, 1) = -t19;
    symbols(1, 2, 2) =  t15;
