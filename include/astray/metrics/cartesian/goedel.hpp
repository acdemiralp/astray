...
public:
  ...
  __device__ christoffel_symbols_type christoffel_symbols(const vector_type& position) const override
  {
    ...
    const auto t20 = position[2] * position[1] * (static_cast<scalar_type>(8) * t1 + t3 + t4) * t14 * t6 * constants::speed_of_light * t16 / static_cast<scalar_type>(8);
    ...
    const auto t30 = t6 * constants::speed_of_light * t16;
    ...
    const auto t47 = t6 / alpha / constants::speed_of_light;
