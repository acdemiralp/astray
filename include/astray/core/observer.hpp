...
public:
  ...
  {
    if (std::holds_alternative<perspective_projection>(projection))
    ...
    const image_size_type& local_offset)
  {
    ...
    const auto&       cast_projection = std::get<perspective_projection> (projection);
    ...
    const image_size_type& local_offset)
  {
    ...
    const auto&       cast_projection = std::get<orthographic_projection>(projection);
